...
(cl:in-package melissa_services-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <WordCount-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WordCount-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name melissa_services-srv:<WordCount-request> is deprecated: use melissa_services-srv:WordCount-request instead.")))

(cl:ensure-generic-function 'words-val :lambda-list '(m))
(cl:defmethod words-val ((m <WordCount-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader melissa_services-srv:words-val is deprecated.  Use melissa_services-srv:words instead.")
  (words m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<WordCount-request>)))
  ...
  "melissa_services/WordCountRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'WordCount-request)))
  "Returns string type for a service object of type 'WordCount-request"
  "melissa_services/WordCountRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <WordCount-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WordCount-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name melissa_services-srv:<WordCount-response> is deprecated: use melissa_services-srv:WordCount-response instead.")))

(cl:ensure-generic-function 'count-val :lambda-list '(m))
(cl:defmethod count-val ((m <WordCount-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader melissa_services-srv:count-val is deprecated.  Use melissa_services-srv:count instead.")
  (count m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<WordCount-response>)))
  ...
  "melissa_services/WordCountResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'WordCount-response)))
  "Returns string type for a service object of type 'WordCount-response"
  "melissa_services/WordCountResponse")
