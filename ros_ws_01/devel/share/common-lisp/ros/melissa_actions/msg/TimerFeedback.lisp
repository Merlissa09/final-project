...
(cl:in-package melissa_actions-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <TimerFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TimerFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name melissa_actions-msg:<TimerFeedback> is deprecated: use melissa_actions-msg:TimerFeedback instead.")))

(cl:ensure-generic-function 'time_elapsed-val :lambda-list '(m))
(cl:defmethod time_elapsed-val ((m <TimerFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader melissa_actions-msg:time_elapsed-val is deprecated.  Use melissa_actions-msg:time_elapsed instead.")
  (time_elapsed m))

(cl:ensure-generic-function 'time_remaining-val :lambda-list '(m))
(cl:defmethod time_remaining-val ((m <TimerFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader melissa_actions-msg:time_remaining-val is deprecated.  Use melissa_actions-msg:time_remaining instead.")
  (time_remaining m))
