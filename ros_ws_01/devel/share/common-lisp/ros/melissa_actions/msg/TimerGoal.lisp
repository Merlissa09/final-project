...
(cl:defmethod cl:initialize-instance :after ((m <TimerGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TimerGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name melissa_actions-msg:<TimerGoal> is deprecated: use melissa_actions-msg:TimerGoal instead.")))

(cl:ensure-generic-function 'time_to_wait-val :lambda-list '(m))
(cl:defmethod time_to_wait-val ((m <TimerGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader melissa_actions-msg:time_to_wait-val is deprecated.  Use melissa_actions-msg:time_to_wait instead.")
  (time_to_wait m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<TimerGoal>)))
  ...
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%# inputs~%duration time_to_wait~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'TimerGoal)))
  "Returns full string definition for message of type 'TimerGoal"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%# inputs~%duration time_to_wait~%~%~%"))
