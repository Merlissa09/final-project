...
(cl:in-package melissa_topics-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Complex>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Complex)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name melissa_topics-msg:<Complex> is deprecated: use melissa_topics-msg:Complex instead.")))

(cl:ensure-generic-function 'real-val :lambda-list '(m))
(cl:defmethod real-val ((m <Complex>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader melissa_topics-msg:real-val is deprecated.  Use melissa_topics-msg:real instead.")
  (real m))

(cl:ensure-generic-function 'imaginary-val :lambda-list '(m))
(cl:defmethod imaginary-val ((m <Complex>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader melissa_topics-msg:imaginary-val is deprecated.  Use melissa_topics-msg:imaginary instead.")
  (imaginary m))
